/**
 * Auto-generated from google/material-design-icons
 * variablefont/MaterialSymbolsOutlined[FILL,GRAD,opsz,wght].codepoints
 * Maps every Material Symbols Outlined icon name (as used in the Stitch
 * mockups, e.g. 'auto_awesome') to its glyph codepoint in the bundled font.
 * Regenerate by re-running the fetch script if the icon set changes.
 */
